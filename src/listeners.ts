...
export function on<T extends Window & typeof globalThis, E extends keyof WindowEventMap>(
	target: T,
	eventType: E,
): AsyncIterableIterator<WindowEventMap[E]>;

export function on(target: Target, eventType: string): AsyncIterableIterator<Event> {
	return createAsyncListener(target, eventType, false);
}

export function once<T extends HTMLElement, E extends keyof HTMLElementEventMap>(
	target: T,
	eventType: E,
): AsyncIterableIterator<HTMLElementEventMap[E]>;
...
export function once<T extends Window & typeof globalThis, E extends keyof WindowEventMap>(
	target: T,
	eventType: E,
): AsyncIterableIterator<WindowEventMap[E]>;

export function once(target: Target, eventType: string): AsyncIterableIterator<Event> {
